...
public class Inventory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i  = 0; i < InventoryItems.Count; i++)
        {
            ...
            InventoryItems[i].Inventoryslot.GetComponent<SlotInfo>().amount.text = ("");
        }
    }
    public void InventoryChange(Item itemInfo)
    {
        if (ItemAlreadyInInventory(itemInfo.itemID) == true)
        {
            ...
            InventoryItems[currentPlace].Inventoryslot.sprite = InventoryItems[currentPlace].thisItem.sprite;
            InventoryItems[currentPlace].Inventoryslot.GetComponent<SlotInfo>().amount.text = (InventoryItems[currentPlace].amount.ToString() + "x");
        ...
        else
        {
            ...
            InventoryItems[currentPlace].Inventoryslot.sprite = InventoryItems[currentPlace].thisItem.sprite;
            InventoryItems[currentPlace].Inventoryslot.GetComponent<SlotInfo>().amount.text = (InventoryItems[currentPlace].amount.ToString() + "x");
            InventoryItems[currentPlace].Inventoryslot.enabled = true;
            InventoryItems[currentPlace].spriteOfThisItem = itemInfo.sprite;
        }
        currentPlace = 0;
    }
